...
{
    public partial class Show_User_All : Form
    {
        SqlConnection conn;
        public Show_User_All()
        {
            InitializeComponent();
        }
        ...
        private void Show_User_All_Load(object sender, EventArgs e)
        {
            connectDB();
            string q = "select dish_id,dish_name,cuisine.cuisine_name,description,diet_type from dish join cuisine on dish.cuisine_id=cuisine.cuisine_id;";
